...
let createDefaultObject = function (schema, obj = {}) {
...
let getMultipleFields = function (schema) {
  let res = []
  each(schema.fields, (field) => {
    if (field.multi === true)
      res.push(field)
...
let mergeMultiObjectFields = function (schema, objs) {
  let model = {}
...
let slugifyFormID = function (schema, prefix = '') {
...
export {createDefaultObject,getMultipleFields,mergeMultiObjectFields,slugifyFormID}
